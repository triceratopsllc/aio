 ...
 */
import { buildOrganizationJsonLd, buildWebSiteJsonLd, buildBreadcrumbJsonLd, buildFaqJsonLd, buildRobotsTxt, buildSitemapXml, } from '../src/core/index.js';
...
console.log('\n=== Breadcrumb (FAQ page) ===');
console.log(JSON.stringify(buildBreadcrumbJsonLd(aupaircareSite, [{ name: 'よくある質問', path: '/faq' }]), null, 2));
console.log('\n=== FAQ ===');
console.log(JSON.stringify(buildFaqJsonLd([
...
console.log(buildSitemapXml(aupaircareSite.siteUrl, [
